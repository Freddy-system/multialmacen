                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    <h5 class="card-title mb-0 flex-grow-1">Lista de Ventas</h5>
                                    <div>
...
<script>
    $(document).ready(function() {
        $('#customerTable').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "index.php?action=apimventa",
            "columns": [
                { "data": "id",
                ...
                { 
                    "data": null,
                    "render": function (data, type, row) {
                        return '<a href="detalleventa?tid=' + row.id + '" class="btn btn-primary btn-sm">Detalle</a>';
                    }
                }
            ],
            "language": {
