                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <p><i class="ri-home-2-line text-primary"></i> <span id="sucursales1" class="text-muted">Recibidor: <?= $datitos->usuarios; ?></span></p>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <p><i class="ri-hand-coin-line text-primary"></i> <span id="adelanto" class="text-muted">Método venta: <?= $datitos->tipoventa; ?></span></p>
