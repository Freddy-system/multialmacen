                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    <h5 class="card-title mb-0 flex-grow-1">Lista de Almacenes</h5>
                                    <div>
                                ...
                                <div class="card-body">
                                    <table class="cambios table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php $datas = AlmacenData::vercontenido();
                        ...
                        <div class="live-preview">
                            <div class="row gy-0">
                                <div class="col-xxl-12 col-md-12">
                                    <label for="customername-field" class="form-label">Nombre del almacén</label>
